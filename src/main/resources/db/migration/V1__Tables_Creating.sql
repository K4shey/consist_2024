...
-- Статус конфигурации (новая, в актуальном состоянии, требуется обновление, ошибка)
CREATE TYPE configurationstatus AS ENUM (
    'NEW',
    'ACTUAL',
    'NEED_UPDATE',
    'ERROR'
...
(
    ...
    status              CONFIGURATIONSTATUS DEFAULT 'NEW'
);
